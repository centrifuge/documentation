...
- [`OnOffRampManager`](https://github.com/centrifuge/protocol/blob/6b9d36eabee48728486f377ea2766a5cd233c555/src/managers/spoke/OnOfframpManager.sol): enables fiat on/off ramps by bridging off-chain settlement into the protocol's accounting.
- [`OnchainPortfolioManager`](https://github.com/centrifuge/protocol/blob/main/src-ir/OnchainPM.sol): manages onchain portfolios, tracking asset positions directly on the balance sheet.
