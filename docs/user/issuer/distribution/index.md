...
3. The issuer executes the approved bucket, issuing tokens for investments or paying out redemptions. Every order in the bucket settles at the price at which the bucket is executed, regardless of when the investor claims.
