...
- **Clear responsibilities**: Centrifuge provides the infrastructure, and each product is issued and managed by its issuer. Questions about a specific product go to its issuer, through the contact details on the product page.
